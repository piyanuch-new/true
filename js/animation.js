...
$(function(){
    ...
    slide.slider({
        ...
        slide: function(event, ui) { //When the slider is sliding
            ...
            if(value <= 5) { 
                volume.css('opacity', '0.05');
                lightfade.css('opacity', '0.10');
            } 
            else if (value <= 15) {
                volume.css('opacity', '0.15');
                lightfade.css('opacity', '0.15');
            } 
            else if (value <= 25) {
                volume.css('opacity', '0.25');
                lightfade.css('opacity', '0.2');
            }
            else if (value <= 35) {
                volume.css('opacity', '0.35');
                lightfade.css('opacity', '0.25');
            }  
            else if (value <= 45) {
                volume.css('opacity', '0.45');
                lightfade.css('opacity', '0.3');
            }  
            else if (value <= 55) {
                volume.css('opacity', '0.55');
                lightfade.css('opacity', '0.35');
            }  
            else if (value <= 65) {
                volume.css('opacity', '0.65');
                lightfade.css('opacity', '0.4');
            }  
            else if (value <= 75) {
                volume.css('opacity', '0.75');
                lightfade.css('opacity', '0.45');
            } 
            else if (value <= 85) {
                volume.css('opacity', '0.85');
                lightfade.css('opacity', '0.5');
            }  
            else if (value <= 95) {
                volume.css('opacity', '0.95');
                lightfade.css('opacity', '0.55');
            }  
            else {
                volume.css('opacity', '1');
                lightfade.css('opacity', '0.6');
            };
